  ...
  setup() {
    ...
    const data = reactive({
      mapCities: [
        ...
        { countryId: "10002", name: "宜蘭縣", count:0 },
        { countryId: "10004", name: "新竹縣", count:0 },
        { countryId: "10005", name: "苗栗縣", count:0 },
        { countryId: "10007", name: "彰化縣", count:0 },
        { countryId: "10008", name: "南投縣", count:0 },
        { countryId: "10009", name: "雲林縣", count:0 },
        { countryId: "10010", name: "嘉義縣", count:0 },
        { countryId: "10013", name: "屏東縣", count:0 },
        ...
        { countryId: "10018", name: "新竹市", count:0 },
        { countryId: "10020", name: "嘉義市", count:0 },
        { countryId: "63", name: "臺北市", count:0 },
        { countryId: "64", name: "高雄市", count:0 },
        { countryId: "65", name: "新北市", count:0 },
        { countryId: "66", name: "臺中市", count:0 },
        { countryId: "67", name: "臺南市", count:0 },
